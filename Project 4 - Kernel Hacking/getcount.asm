...
int main(int argc, char *argv[])
{
  ...
  21:	e8 7a 00 00 00       	call   a0 <strcmp>
  26:	83 c4 10             	add    $0x10,%esp
  29:	85 c0                	test   %eax,%eax
  2b:	75 32                	jne    5f <main+0x5f>
		argument = -1;
		printf(1, "Counter has been reset, last value was: ");
  2d:	50                   	push   %eax
  2e:	50                   	push   %eax
  2f:	68 a0 07 00 00       	push   $0x7a0
  34:	6a 01                	push   $0x1
  ...
  44:	50                   	push   %eax
  45:	e8 29 03 00 00       	call   373 <getcnt>
  4a:	83 c4 0c             	add    $0xc,%esp
  4d:	50                   	push   %eax
  4e:	68 9b 07 00 00       	push   $0x79b
  53:	6a 01                	push   $0x1
  55:	e8 d6 03 00 00       	call   430 <printf>
	exit();
  5a:	e8 74 02 00 00       	call   2d3 <exit>
		argument = atoi(argv[1]);
  5f:	83 ec 0c             	sub    $0xc,%esp
  62:	ff 73 04             	pushl  0x4(%ebx)
  65:	e8 f6 01 00 00       	call   260 <atoi>
  6a:	83 c4 10             	add    $0x10,%esp
  6d:	eb d2                	jmp    41 <main+0x41>
  6f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb c9 07 00 00       	mov    $0x7c9,%ebx
        while(*s != 0){
 ...
 626:	73 10                	jae    638 <free+0x38>
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf 80 0a 00 00       	mov    $0xa80,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 80 0a 00 00 80 	movl   $0xa80,0xa80
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
